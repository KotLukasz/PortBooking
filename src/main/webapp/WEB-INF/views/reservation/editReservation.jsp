...
<table class="tableClass">
    ...
    <tr class="map">
        <td id="portName">${reservation.portReservation.portName}</td>
        <td>${reservation.portReservation.price} PLN</td>
        <td id="markerPositionLat" hidden>${reservation.portReservation.markerPositionLat}</td>
        <td id="markerPositionLng" hidden>${reservation.portReservation.markerPositionLng}</td>
        <td>
