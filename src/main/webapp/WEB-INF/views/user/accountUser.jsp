...
<td>
    ...
    <a href="http://localhost:8080/PortBooking_war_exploded/reservation/showAllPorts/${user.id}">Show Ports</a> <br/>
    <a href="http://localhost:8080/PortBooking_war_exploded/reservation/showReservations/${user.id}">Show Reservations</a> <br/>
